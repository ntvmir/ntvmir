...
<jsp:param name="header" value="Ленты новостей"/>
...
<%=sPrivate%><A HREF="news_list.jsp?page_id=<%=node.getId()%>"><%=buildPath(node)%></A>
<%		}else{ %>
...
<A HREF="news_edit.jsp?page_id=<%=node.getId()%>&id=">добавить новость</A>
<%		}else{ %>
добавить новость
<%		} %></NOBR>
</TD>
...
<TABLE BORDER="0" CELLSPACING="1" CELLPADDING="1" WIDTH="700">
<FORM METHOD="post" ACTION="xt_news.jsp">
<INPUT TYPE="hidden" NAME="mode" VALUE="set_num">
<TR>
<TD HEIGHT="20" CLASS="c3"><DIV STYLE="padding-left:6px;padding-right:6px">
Количество новостей на странице:&nbsp;&nbsp;&nbsp;
<INPUT TYPE="text" NAME="press_num" SIZE="5" VALUE="<%=News.getPagePressAmount()%>"><BR>
</DIV></TD>
</TR>
<TR>
